...
export const FELLOWSHIPS: { [fellowshipName in FellowshipName]: Fellowship } = {
        ...
        activities: [
            {
                ...
                image: `${process.env.PUBLIC_URL}/assets/women_bible_study.jpg`,
            },
            {
                name: "Prayer & Intercession",
                description: "Gathering to pray for the church, families, and personal needs.",
                image: `${process.env.PUBLIC_URL}/assets/women_prayer.jpg`,
            },
            {
                name: "Ladies' Retreat",
                description: "A time of reflection, renewal, and connection with God and each other.",
                image: `${process.env.PUBLIC_URL}/assets/women_retreat.jpg`,
            },
        ],
    ...
    [FellowshipName.Youth]: {
        name: PageName.Youth,
        heroImage: `${process.env.PUBLIC_URL}/assets/youth_fellowship.jpg`,
    ...
    [FellowshipName.Family]: {
        ...
        heroImage: `${process.env.PUBLIC_URL}/assets/family_fellowship.jpg`,
