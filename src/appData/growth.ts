...
/**
 * Spiritual growth and discipleship program data
 * 
 * This file contains information about church programs focused on spiritual growth,
 * including cell groups and Sunday school. Each program includes details about
 * activities, purpose, and how to get involved.
 */
export const GROWTH_GROUPS: { [growthGroupName in GrowthGroupName]: GrowthGroup } = {
    [GrowthGroupName.CellGroups]: {
        ...
        heroImage: `/assets/cell_hero.jpg`,
    ...
    [GrowthGroupName.SundaySchool]: {
        ...
        heroImage: `/assets/sunday_hero.jpg`,
