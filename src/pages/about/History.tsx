    ...
    return (
        ...
        >
            <Container maxWidth="lg">
                ...
                >
                    <Typography variant="h4" sx={{ fontWeight: "bold", mb: 4, color: "#7b523a" }}>
                        Our Church History
                    </Typography>

                    <Typography variant="body1" paragraph sx={{ textAlign: "justify", color: "#444", fontSize: "18px", lineHeight: 1.8 }}>
                    ...
                    <CardMedia
                        ...
                        alt="Church History"
                        sx={{ maxWidth: "100%", borderRadius: 2, marginTop: 4 }}
                    />
                </Paper>
            </Container>
        </Box>
